...
import { fetchRawMaterials, fetchInwardEntries, recordInwardEntry } from '../../services/api/stock';
...
export default function Inward() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      setEntries(entriesRes.entries || entriesRes.data || []);
    } catch (err) {
  ...
  return (
    <div className="bg-gradient-to-r from-blue-50 to-blue-100 min-h-screen p-6">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-3xl font-bold text-gray-800 mb-6">Inward Entries</h2>
              ...
              <table className="w-full">
                <thead className="bg-gradient-to-r from-blue-500 to-blue-600 text-white">
                  <tr>
                    ...
                    <th className="px-6 py-3 text-left font-semibold">Quantity (Kg)</th>
                ...
                <tbody>
                  {paginatedEntries.map((entry, index) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-gray-700">{entry.quantityKg} Kg</td>
                      <td className="px-6 py-4 text-gray-700">{entry.remarks || '-'}</td>
