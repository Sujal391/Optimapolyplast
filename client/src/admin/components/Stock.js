...
const StockHistory = () => {
  ...
  return (
    <div className="flex min-h-screen bg-gray-100 ">
      ...
      <div className="mt-5 flex-1 transition-all overflow-hidden duration-300 p-6 flex justify-center items-center">
        <div className="w-full max-w-7xl">
          <header className="flex flex-col sm:flex-row sm:justify-between sm:items-center bg-white px-4 py-4 shadow-lg rounded-lg mb-6 gap-2 sm:gap-0">
            <div className="flex items-center gap-4 mb-2 sm:mb-0">
              <button
                className="lg:hidden bg-gradient-to-r from-blue-500 to-indigo-600 text-white px-3 py-2 rounded-lg shadow-md hover:from-blue-600 hover:to-indigo-700 transition-all text-sm"
                onClick={() => setIsSidebarOpen(!isSidebarOpen)}
              >
                ☰
              </button>
            ...
            <button
              onClick={handleDownload}
              className="bg-gradient-to-r from-green-500 to-teal-600 text-white px-4 py-2 rounded-lg shadow-md hover:from-green-600 hover:to-teal-700 transition-all text-sm w-full sm:w-auto"
            >
              Download History
            </button>
          </header>
          ...
          <main>
            ...
            <section className="bg-white rounded-xl shadow-xl p-4">
              <div className="mb-8 flex flex-col sm:flex-row sm:items-end gap-4">
                <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                  <div className="w-full sm:w-auto">
                    ...
                    <DatePicker
                      selected={startDate}
                      onChange={(date) => setStartDate(date)}
                      className="w-full sm:w-32 border border-gray-300 p-2 sm:p-3 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                      dateFormat="dd/MM/yyyy"
                    />
                  </div>
                  <div className="w-full sm:w-auto">
                ...
                <button
                  onClick={handleFilter}
                  className="bg-gradient-to-r from-blue-500 to-indigo-600 text-white px-4 py-2 rounded-lg shadow-md hover:from-blue-600 hover:to-indigo-700 transition-all text-sm w-full sm:w-auto"
                >
                  Filter
                </button>
              </div>
              ...
              <div className="w-full overflow-x-hidden rounded-lg shadow-md">
                <table className="w-full table-fixed text-xs sm:text-sm border-collapse bg-white">
                  <thead>
                    <tr className="bg-gradient-to-r from-gray-100 to-gray-200">
                      <th className="px-1 py-1 sm:px-2 sm:py-2 text-left text-gray-700 font-semibold">
                        Last Updated
                      </th>
                      <th className="px-1 py-1 sm:px-2 sm:py-2 text-left text-gray-700 font-semibold">
                        Product
                      ...
                      <th className="px-1 py-1 sm:px-2 sm:py-1 text-left text-gray-700 font-semibold">
                        Update History
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    {stockHistory.map((stock) => (
                      ...
                      >
                        <td className="px-1 py-1 truncate max-w-[120px] text-gray-700 whitespace-nowrap">
                          {new Date(stock.lastUpdated).toLocaleString()}
                        ...
                        <td className="px-1 py-1 truncate max-w-[60px] text-gray-700">
                          {stock.currentQuantity}
                        </td>
                        <td className="px-1 py-1 truncate max-w-[80px] text-gray-700">
                          ...
                          <div className="max-h-32 overflow-y-auto custom-scrollbar">
                            {[...stock.stockAdditionHistory]
                              ...
                              .map((addition, index) => (
                                <div
                                  key={index}
                                  className="mb-1 p-1 bg-orange-50 rounded shadow-sm"
                                >
                                  <p className="text-xs text-orange-700 mb-0">
                                    {new Date(addition.date).toLocaleString()}
                                  </p>
                                  <p className="text-xs text-orange-600 mb-0">
                                    Added:{" "}
                                    <span className="font-medium">
                                      {addition.quantity}
                                    </span>
                                  </p>
                                  <p className="text-xs text-orange-500 mb-0">
                          ...
                          <div className="max-h-32 overflow-y-auto custom-scrollbar">
                            {[...stock.updateHistory]
                              ...
                              .map((update, index) => (
                                <div
                                  key={index}
                                  className="mb-1 p-1 bg-gray-50 rounded shadow-sm"
                                >
