...
//               <h2 className="text-2xl font-bold mb-6">Total Stocks Products</h2>
//               <div>
...
//           {product.stockUpdateInfo && (
//   <div className="mt-2 border-t pt-2 bg-gradient-to-r from-blue-300 via-purple-450 to-blue-500 p-4 rounded-md shadow-md">
//     <p className="text-sm text-white-399 font-semibold">
//       Last Update: {product.stockUpdateInfo.lastUpdate.message}
//     </p>
//     <div className="text-xs text-white bg-pink-700 p-3 rounded-lg mt-3 shadow-sm">
//       <p>By: {product.stockUpdateInfo.lastUpdate.updatedBy}</p>
//       <p>On: {new Date(product.stockUpdateInfo.lastUpdate.updatedAt).toLocaleDateString()}</p>
//       <p>Change: {product.stockUpdateInfo.lastUpdate.changeType === 'increase' ? '+' : '-'}
//         {product.stockUpdateInfo.lastUpdate.quantity}</p>
//     </div>
//     <p className="text-xs text-white bg-indigo-800 p-3 rounded-lg mt-1 shadow-sm">
//       Total updates: {product.stockUpdateInfo.totalUpdates}
//     </p>
//   </div>
// )}
