...
const Product = () => {
  ...
  return (
    <div className="flex min-h-screen bg-blue-50 md:(min-width:768px) sm:(min-width:640px) md:p2 md:text-base sm-p1 sm-text-sm ">
      <Sidebar
        isOpen={isOpen}
        isMobile={isMobile}
      ...
      <div className="mt-10 gap-5 flex-1 transition-all overflow-hidden duration-300 p-6 flex justify-center items-center">
        <div className="w-full max-w-7xl overflow-x-hidden">
          <header className="flex flex-col sm:flex-row sm:justify-between sm:items-center bg-white px-2 py-4 mt-4 shadow-md gap-2 sm:gap-0 w-full">
            ...
            <div className="flex flex-col items-center space-y-2 sm:flex-row sm:justify-center sm:items-center sm:space-y-0 sm:space-x-4 w-full">
              {/* Product Type Dropdown - Custom Listbox */}
              <Listbox value={productType} onChange={setProductType}>
                <div className="relative w-full sm:w-auto">
                  <Listbox.Button className="w-full border rounded-md px-2 py-2 bg-white text-left">
                    {productType || "All Types"}
                  </Listbox.Button>
                  <Listbox.Options className="absolute z-10 mt-1 w-full bg-white border rounded-md shadow-lg max-h-40 overflow-auto">
                    <Listbox.Option value="" className="text-center">
                      All Types
                    </Listbox.Option>
                    <Listbox.Option value="Bottle" className="text-center">
                      Bottle
                    </Listbox.Option>
                    <Listbox.Option
                      value="Raw Material"
                ...
                <div className="relative w-full sm:w-auto">
                  ...
                  <Listbox.Options className="absolute z-10 mt-1 w-full bg-white border rounded-md shadow-lg max-h-40 overflow-auto">
                    ...
                    {productType === "Raw Material" ? (
                      <>
                        <Listbox.Option
                          value="25 mm Plastic ROPP Cap"
                          className="text-center"
                        >
                          25 mm Plastic ROPP Cap
                        </Listbox.Option>
                        <Listbox.Option
                          value="Narrow Neck Cap"
                          className="text-center"
                        >
                          Narrow Neck Cap
                        </Listbox.Option>
                        ...
                        <Listbox.Option
                          value="26/22 Shortneck caps"
                          className="text-center"
                        >
                          26/22 Shortneck caps
                        </Listbox.Option>
                        <Listbox.Option
                          value="27mm Alaska caps"
                          className="text-center"
                        >
                          27mm Alaska caps
                        </Listbox.Option>
                      ...
                      <>
                        <Listbox.Option value="200ml" className="text-center">
                          200ml
                        </Listbox.Option>
                        <Listbox.Option value="250ml" className="text-center">
                          250ml
                        </Listbox.Option>
                        <Listbox.Option value="500ml" className="text-center">
                          500ml
                        </Listbox.Option>
                        <Listbox.Option value="700ml" className="text-center">
                          700ml
                        </Listbox.Option>
                        <Listbox.Option value="1L" className="text-center">
                          1L
                        </Listbox.Option>
                        <Listbox.Option value="2L" className="text-center">
                          2L
                        </Listbox.Option>
                        <Listbox.Option value="5L" className="text-center">
                          5L
                        </Listbox.Option>
                      </>
                    )}
              ...
              <button
                className="bg-blue-500 text-white w-full sm:w-auto text-base sm:text-lg py-3 sm:py-2 px-4 rounded-md shadow hover:bg-blue-600 transition-all"
                onClick={() => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
          <div className="col-span-1 flex flex-col items-center">
            <label
              ...
              className="border-dashed border-2 border-gray-600 flex justify-center items-center rounded-lg w-full h-40 sm:h-48 cursor-pointer"
            >
              <input
                type="file"
                id="upload-photo"
            ...
            {(editingProduct?.image || image) && (
              <div className="mt-4 w-full flex justify-center items-center">
                <img
                  ...
                  alt="Product Preview"
                  className="w-full h-auto max-h-40 sm:max-h-48 object-contain rounded-lg m-0"
                />
              </div>
            )}
          </div>
      ...
      <div className="relative h-48">
        ...
        <div className="absolute top-2 right-2 flex gap-2">
          <button
            ...
            className="p-2 bg-blue-600 text-white active:scale-90 rounded-full hover:bg-blue-700"
          >
            ✏️
          </button>
          <button
            onClick={() => onDelete(product._id)}
            className="p-2 bg-red-500 active:scale-90  text-white rounded-full hover:bg-red-700"
          >
            🗑️
          </button>
        </div>
