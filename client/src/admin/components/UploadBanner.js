...
const BannerManagement = () => {
  ...
  return (
    <div className="flex">
      ...
      <div className="flex-1 mt-20 p-4 rounded-3xl flex justify-center items-center overflow-hidden md:(min-width:768px) sm:(min-width:640px) md:p2 md:text-base sm-p1 sm-text-sm">
        {/* <div className="flex-1 mt-20 p-4 rounded-3xl flex justify-center items-center overflow-hidden md:(min-width:768px) sm:(min-width:640px) md:p2 md:text-base sm-p1 sm-text-sm"> */}
        <div className="w-full max-w-7xl">
          <div className=" mx-auto bg-white shadow-lg rounded-xl mt-6">
            <div className="flex items-center justify-between p-6 border-b bg-blue-700">
              <h1 className="text-3xl text-white">Banner Management</h1>
              <button
                onClick={() => setIsModalOpen(true)}
            ...
            {/* <motion.div className="overflow-x-auto p-4">
              <table className="table-auto w-full text-lg text-left border-collapse">
                <thead>
                  <tr className="divide-x divide-gray-200">
                    <th className="px-5 py-2 w-1/4 text-center align-middle">
                      Image
                    </th>
                    <th className="px-5 py-2 w-1/4 text-center align-middle">
                      Order
                    ...
                    >
                      <td className="px-5 py-2 align-middle">
                        <img
                          ...
                          src={banner.image}
                          alt={`Banner ${banner.order}`}
                          className="w-24 h-16 object-cover rounded cursor-pointer hover:scale-105 transition-transform duration-200 mx-auto"
                          onClick={() => setZoomImage(banner.image)}
                        />
                      </td>
                      <td className="px-5 py-2 align-middle">{banner.order}</td>
                      <td className="px-5 py-2 align-middle">
                        {banner.isActive ? "Active" : "Inactive"}
                      </td>
                      <td className="px-5 py-2 align-middle">
                        <button
                          onClick={() => handleDelete(banner._id)}
                          className="ml-0 text-red-500 bg-red-200 hover:bg-red-400 hover:text-red-700 px-6 py-2 rounded-lg"
                        >
                          Delete🗑️
                        </button>
                      </td>
            ...
            <motion.div className="p-1 overflow-x-hidden sm:mx-2">
              <div className="max-w-7xl mx-auto w-full">
                {/* <Table className="min-w-[300px] text-xs  sm:text-sm md:text-base"> */}
                <Table className="min-w-[300px] text-sm sm:text-base ">
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableRow key={banner._id}>
                        <TableCell className="text-center">
                          <img
                            src={banner.image}
                            alt={`Banner ${banner.order}`}
                            className="w-30 h-16 object-cover sm:w-34 rounded mx-auto hover:scale-105 transition-transform duration-200 cursor-pointer"
                            onClick={() => setZoomImage(banner.image)}
                          />
                        </TableCell>
                        <TableCell className="text-center">
                        ...
                        <TableCell className="text-center">
                          <button
                            onClick={() => handleDelete(banner._id)}
                            className="text-red-500 bg-red-200 hover:bg-red-400 hover:text-red-700 px-4 py-1 rounded-lg"
                          >
                            Delete 🗑️
                          </button>
                        </TableCell>
